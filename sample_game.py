...
st.markdown(" <p style = 'color: black;font-family:lucida comsole;'> NAME:Abdul Rafi N</p>",unsafe_allow_html=True)
...
st.markdown("<p style = 'color : black; font-family:lucida console';>ROLL NO: 24UCS102</p>",unsafe_allow_html=True)
